...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    echo "  qemu-system-x86_64 -m 2G -enable-kvm -bios ${pkgs.OVMF.fd}/FV/OVMF.fd -drive file=../result/nixos.qcow2,if=virtio -net nic,model=virtio -net user,hostfwd=tcp::2222-:22 -nographic"
    echo ""
